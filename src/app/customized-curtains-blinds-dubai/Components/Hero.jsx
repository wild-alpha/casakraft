...
const Hero = () => {
  ...
  return (
    <div className="relative w-full h-auto md:h-[500px] lg:h-[550px] overflow-hidden">
      <Image
        src="/images/apartment-bedroom-curtains-in-dubai.png"
        alt="Apartment Bedroom Curtains In Dubai"
        width={1920}
        height={1080}
        priority
      ...
      Customized Curtains and Blinds
          ...
          <p className="text-xs md:text-sm font-play mt-4 mb-6 opacity-90">
            Best custom curtains and blinds manufacturer in Dubai. Premium fabrics, made-to-measure window treatments, and professional installation.</p>
